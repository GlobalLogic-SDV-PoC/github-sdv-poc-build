...
struct ecuPar ecuPar = {
        ...
        10000,                     /* Default cycle time in us (10ms) */
        3.0,                       /* period */
        0.0,                       /* offset */
        0,                         /* phase */
        400.0,                     /* ampl */
        {{0, 0, 0, 0, 0, 0, 1, 2}, /* map1_8_8 */
          ...
          {1, 1, 2, 4, 5, 8, 9, 10},
          { 1, 1, 3, 5, 8, 9, 10, 10}},
        {0, 1, 3, 6, 9, 15, 20, 30, 38, 42, 44, 46, 48, 50, 48, 45, 40, 33, 25, 15, 5, 4, 3, 2, 1,
          0, 0, 1, 4, 8, 4, 0}          /* curve1_32 */
};
...
void ecuCreateA2lDescription()
{
        ...
        A2lCreateParameterWithLimits(ecuPar.cycleTimeUs, A2L_TYPE_UINT32,
                                     "ECU task cycle time in us", "us", 50, 1000000);
        ...
        /* Measurements */
        /* Associate XCP event "EcuCyclic" to the variables created below */
        ...
        A2lMeasurementGroup("EcuTaskSignals", 11,
                            "channel1", "channel2", "channel3", "byteCounter", "wordCounter",
                            "dwordCounter", "sbyteCounter", "swordCounter", "sdwordCounter",
                            "longArray1",
                            "byteArray1");
}
...
/* ECU cyclic (10ms default) demo task */
#ifdef _WIN
...
{
        (void)p;
        log_info("Start C task (cycle = %dus, XCP event = %d)\n", ecuCalPage->cycleTimeUs,
               gXcpEvent_EcuCyclic);
